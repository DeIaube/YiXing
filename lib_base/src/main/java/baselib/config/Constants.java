...
public interface Constants {
    ...
    String AROUTER_GOODS_NEARBY_FRAGMENT = "/goods/nearby_fragment";
    String AROUTER_GOODS_NEARBY_ACTIVITY = "/goods/nearby_activity";
    ...
    String AROUTER_WALLET_ALI_PAY = "/wallet/ali_pay";
