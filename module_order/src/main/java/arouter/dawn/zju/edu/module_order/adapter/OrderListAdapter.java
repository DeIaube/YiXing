...
public class OrderListAdapter extends RecyclerView.Adapter<OrderListAdapter.OrderListHolder> {
    ...
    private String getTypeString(int type) {
        if (type == Constants.ORDER_TYPE_PAYMENT) {
            return App.getAppalication().getString(R.string.order_home_list_type_payment);
        } else if (type == Constants.ORDER_TYPE_COMPLETE_REQUE_EVALUATE) {
            return App.getAppalication().getString(R.string.order_home_list_type_reque_evaluate);
        } else if (type == Constants.ORDER_TYPE_COMPLETE_EVALUATED) {
            return App.getAppalication().getString(R.string.order_home_list_type_evaluated);
        } else {
            return App.getAppalication().getString(R.string.order_home_list_type_all);
        }
    }
